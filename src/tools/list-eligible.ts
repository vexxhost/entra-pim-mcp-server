    ...
    async () => {
      try {
        ...
        const [groupData, groupActive, roleData, roleActive] = await Promise.all([
          client.identityGovernance.privilegedAccess.group.eligibilitySchedules
            .filterByCurrentUserWithOn('principal')
            .get({ queryParameters: { expand: ['group'] } }),
          client.identityGovernance.privilegedAccess.group.assignmentScheduleInstances
            .filterByCurrentUserWithOn('principal')
            .get(),
          client.roleManagement.directory.roleEligibilitySchedules
            .filterByCurrentUserWithOn('principal')
            .get({ queryParameters: { expand: ['roleDefinition'] } }),
          client.roleManagement.directory.roleAssignmentScheduleInstances.filterByCurrentUserWithOn('principal').get(),
        ]);
